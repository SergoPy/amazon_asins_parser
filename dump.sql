...
--
-- Name: webscraper_advertisingmonitoring; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.webscraper_advertisingmonitoring (
    id bigint NOT NULL,
    created_at timestamp with time zone NOT NULL,
    seller_name character varying(64) NOT NULL,
    product_name character varying(64) NOT NULL,
    frequency integer NOT NULL,
    google_sheet_link character varying(200) NOT NULL,
    asins character varying(255) NOT NULL,
    target_acos integer NOT NULL,
...
ALTER TABLE public.webscraper_advertisingmonitoring OWNER TO admin;

--
-- Name: webscraper_advertisingmonitoring_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.webscraper_advertisingmonitoring ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.webscraper_advertisingmonitoring_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: webscraper_asinsmonitoring; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.webscraper_asinsmonitoring (
    id bigint NOT NULL,
    created_at timestamp with time zone NOT NULL,
    seller_name character varying(64) NOT NULL,
    product_name character varying(64) NOT NULL,
    frequency integer NOT NULL,
    google_sheet_link character varying(200) NOT NULL,
    personal_asin character varying(10) NOT NULL,
    competitor_asins character varying(100) NOT NULL,
    keywords text NOT NULL,
    last_run timestamp with time zone NOT NULL,
    base_url character varying(200) NOT NULL,
    country_cookie text NOT NULL
);


ALTER TABLE public.webscraper_asinsmonitoring OWNER TO admin;

--
-- Name: webscraper_asinsmonitoring_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.webscraper_asinsmonitoring ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.webscraper_asinsmonitoring_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
25	Can add advertising monitoring	7	add_advertisingmonitoring
26	Can change advertising monitoring	7	change_advertisingmonitoring
27	Can delete advertising monitoring	7	delete_advertisingmonitoring
28	Can view advertising monitoring	7	view_advertisingmonitoring
29	Can add asins monitoring	8	add_asinsmonitoring
30	Can change asins monitoring	8	change_asinsmonitoring
31	Can delete asins monitoring	8	delete_asinsmonitoring
32	Can view asins monitoring	8	view_asinsmonitoring
\.
...
6	sessions	session
7	webscraper	advertisingmonitoring
8	webscraper	asinsmonitoring
\.
...
1	contenttypes	0001_initial	2023-09-16 16:36:52.34859+00
2	auth	0001_initial	2023-09-16 16:36:52.410906+00
3	admin	0001_initial	2023-09-16 16:36:52.435131+00
4	admin	0002_logentry_remove_auto_add	2023-09-16 16:36:52.447535+00
5	admin	0003_logentry_add_action_flag_choices	2023-09-16 16:36:52.457531+00
6	contenttypes	0002_remove_content_type_name	2023-09-16 16:36:52.476162+00
7	auth	0002_alter_permission_name_max_length	2023-09-16 16:36:52.486158+00
8	auth	0003_alter_user_email_max_length	2023-09-16 16:36:52.497318+00
9	auth	0004_alter_user_username_opts	2023-09-16 16:36:52.505948+00
10	auth	0005_alter_user_last_login_null	2023-09-16 16:36:52.5148+00
11	auth	0006_require_contenttypes_0002	2023-09-16 16:36:52.517062+00
12	auth	0007_alter_validators_add_error_messages	2023-09-16 16:36:52.526893+00
13	auth	0008_alter_user_username_max_length	2023-09-16 16:36:52.539606+00
14	auth	0009_alter_user_last_name_max_length	2023-09-16 16:36:52.549174+00
15	auth	0010_alter_group_name_max_length	2023-09-16 16:36:52.559067+00
16	auth	0011_update_proxy_permissions	2023-09-16 16:36:52.568965+00
17	auth	0012_alter_user_first_name_max_length	2023-09-16 16:36:52.578398+00
18	sessions	0001_initial	2023-09-16 16:36:52.591124+00
19	webscraper	0001_initial	2023-09-16 16:36:52.606554+00
20	webscraper	0002_advertisingmonitoring_last_run_and_more	2023-09-16 16:36:52.614678+00
21	webscraper	0003_alter_asinsmonitoring_keywords	2023-09-16 16:36:52.618785+00
22	webscraper	0004_asinsmonitoring_base_url_and_more	2023-09-16 16:36:52.625178+00
\.
...
--
-- Data for Name: webscraper_advertisingmonitoring; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.webscraper_advertisingmonitoring (id, created_at, seller_name, product_name, frequency, google_sheet_link, asins, target_acos, entity_id, login, password, last_run) FROM stdin;
\.


--
-- Data for Name: webscraper_asinsmonitoring; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.webscraper_asinsmonitoring (id, created_at, seller_name, product_name, frequency, google_sheet_link, personal_asin, competitor_asins, keywords, last_run, base_url, country_cookie) FROM stdin;
\.
...
--
-- Name: webscraper_advertisingmonitoring_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.webscraper_advertisingmonitoring_id_seq', 1, false);


--
-- Name: webscraper_asinsmonitoring_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.webscraper_asinsmonitoring_id_seq', 1, false);
...
--
-- Name: webscraper_advertisingmonitoring webscraper_advertisingmonitoring_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.webscraper_advertisingmonitoring
    ADD CONSTRAINT webscraper_advertisingmonitoring_pkey PRIMARY KEY (id);


--
-- Name: webscraper_asinsmonitoring webscraper_asinsmonitoring_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.webscraper_asinsmonitoring
    ADD CONSTRAINT webscraper_asinsmonitoring_pkey PRIMARY KEY (id);
